"""Script to plot monoenergetic backscatter jet cork simulation results.

Loads data from 'Backscatter_Dominated_Cork_Data_Mono_Energetic/Backscatter_Dominated_Cork_Data.h5'
and generates symmetrical light curves.
"""
...
VIEWING_ANGLES = [0.055, 0.105, 0.155, 0.305]
