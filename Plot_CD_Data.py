...
with h5.File(FILE_PATH, 'r') as f:
    # SP.PlotTheta(f,num_bins = 500)
    # SP.PlotPolarizationVsTheta(f,OUTPUT_PATH,num_bins = 300)
    ...
    # SP.PlotPolarizationVsEnergy(f,VIEWING_ANGLES,OUTPUT_PATH,num_bins = 30)
    ...
    # SP.PlotPolarizationVsTime(f,VIEWING_ANGLES,OUTPUT_PATH,num_bins = 20, shift_t0 = True,restrict_time=True)
