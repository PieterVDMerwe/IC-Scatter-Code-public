"""Script to plot multi-scatter Compton Drag simulation results.

Loads data from 'Compton_Drag_Multi_Scatter_Data.h5' and generates various
diagnostic plots (e.g. theta/phi distributions, energy SEDs, polarization,
and light curves).
"""
