"""Main execution script for monoenergetic backscatter-dominated jet cork simulation.

This script sets up physical constants and parameters, runs multiple Monte Carlo
simulation iterations for a backscatter-dominated jet cork with monoenergetic spectrum,
buffers the escaping photon data, and writes the results to an HDF5 file.
"""

import Shared.Distributions as SD
import Shared.Core_IC as IC
import Shared.Common as SC
import Shared.Backscatter_Dominated_Cork_Mono_Energetic as BS
...
FILE_PATH = "Backscatter_Dominated_Cork_Data_Mono_Energetic/Backscatter_Dominated_Cork_Data.h5"
