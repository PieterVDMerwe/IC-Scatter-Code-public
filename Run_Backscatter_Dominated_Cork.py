"""Main execution script for backscatter-dominated jet cork simulation.

This script sets up physical constants and parameters, runs multiple Monte Carlo
simulation iterations for a backscatter-dominated jet cork with pair annihilation
spectrum, buffers the escaping photon data, and writes the results to an HDF5 file.
"""
