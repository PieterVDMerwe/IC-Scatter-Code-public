"""Main execution script for single-scatter Compton Drag jet shell simulation.

This script sets up physical constants and parameters (e.g. temperatures, radii,
jet angle constraints), runs multiple Monte Carlo simulation iterations for
Compton Drag single scatterings, buffers the output data, and flushes it to HDF5.
"""

import Shared.Distributions as SD
import Shared.Core_IC as IC
import Shared.Common as SC
import Shared.Compton_Drag as CD
...
FILE_PATH = "Compton_Drag_Data/Compton_Drag_Data.h5"
...
for i in range(NUMBER_OF_RUNS):
    photon_energies, photon_wave_vector, photon_position, Q, U, final_iteration, photon_theta, photon_phi = CD.RunComptonDrag(THETA_R_STAR, THETA_E, THETA_J, BULK_LORENTZ_0, Z_0, Z_STAR, Z_T, Z_MAX, E_F, N_PHOTONS)
