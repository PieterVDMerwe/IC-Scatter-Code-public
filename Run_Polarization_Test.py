"""Main execution script for polarization testing under Compton Drag.

This script runs a quick polarization testing simulation (usually 1 run) using
simplified constants and saves the output polarization distributions and Stokes
parameters to HDF5.
"""
...
import Shared.Polarization_Test as PT
...
FILE_PATH = "Polarizations_Test/Polarizations_Test.h5"
...
for i in range(NUMBER_OF_RUNS):
    photon_energies, photon_wave_vector, photon_position, Q, U, final_iteration, photon_theta, photon_phi = PT.RunComptonDrag(THETA_R_STAR, THETA_E, THETA_J, BULK_LORENTZ_0, Z_0, Z_STAR, Z_T, Z_MAX, E_F, N_PHOTONS)
